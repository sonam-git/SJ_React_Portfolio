  ...
  return (
    <AppBar style={appBarStyles}>
      <Toolbar>
        {isMatch ? (
          <>
            <Avatar style={{ fontSize: "1.5rem",boxShadow: "0 5px 8px rgba(10, 20, 10, 5.2)"}} src={sonam} alt="Sonam" />
            <DrawerComponent links={links} />
          </>
        ) : (
          <Grid container alignItems="center">
            <Grid item xs={6}>
              <Avatar style={{ fontSize: "2rem",width: 56, height: 56, boxShadow: "0 5px 8px rgba(10, 20, 10, 5.2)" }} src={sonam} />
            </Grid>
